                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 custom-bg text-light">
                                ...
                                <img className="mb-3 screenshot" alt={altdesc} src={this.state.infogame[0].screenshot}></img><br></br>
                                <a className="btn btn-primary mr-2 mt-3 mb-2 btn-font" href={this.state.infogame[0].link}>Telechargement</a>
                            </div>
                        </div>
                    </div>
                </div>
