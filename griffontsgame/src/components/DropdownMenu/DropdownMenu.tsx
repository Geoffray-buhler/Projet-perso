...
const BtnDropdown = ({gamename}) => {
    ...
    return <Link className="btn btn-customcolor ml-2 mb-2" to={`/Seconde_games/${gamename}`} onClick={() => { dispatch({type:"change-game",newGame:gamename});}}><div className="btn-font">{gamename}</div></Link>
}
